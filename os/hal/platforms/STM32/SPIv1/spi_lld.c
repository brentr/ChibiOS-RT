...
static void PASTE(startSpi,STM32_SPI_DMA)(SPIDriver *spip, uint32_t priority)
// allocate dma resources for driver spip and start channel
//   panics if DMA channel cannel be allocated
{
...
static void PASTE(startSpi,STM32_SPI_POLL)(SPIDriver *spip, uint32_t priority)
